...
import { faPhone, faBars, faEnvelope, faAngleDown, faAngleUp, faCross  } from '@fortawesome/free-solid-svg-icons';
...
library.add(faPhone, faBars, faWhatsapp, faInstagram, faFacebook, faEnvelope, faAngleDown, faAngleUp, faCross );
