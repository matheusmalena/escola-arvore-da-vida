...
import { faPhone, faBars, faEnvelope, faAngleDown, faAngleUp, faCross, faStar  } from '@fortawesome/free-solid-svg-icons';
...
library.add(faPhone, faBars, faWhatsapp, faInstagram, faFacebook, faEnvelope, faAngleDown, faAngleUp, faCross, faStar );
